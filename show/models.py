...
class Rent12(models.Model):
    ...
    toward = models.CharField(max_length=80, blank=True, null=True)
    level = models.CharField(max_length=80, blank=True, null=True)
    ...
    pred_money = models.FloatField(blank=True, null=True)
